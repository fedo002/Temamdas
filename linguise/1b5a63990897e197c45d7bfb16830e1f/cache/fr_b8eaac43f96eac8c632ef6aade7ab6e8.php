...
<div class="balance-cards">
    ...
    <div class="balance-card main-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">38 326,47 USDT</div>
        </div>
    ...
    <div class="balance-card mining-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">146.332000 USDT</div>
        </div>
        <div class="balance-icon">
...
<div class="recent-transactions">
    ...
    <div class="transactions-list">
            ...
            <div class="transaction-details">
                ...
                <div class="transaction-date">17 mars 2025, 20:26</div>
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">R&#xE9;compense du jeu</span>                </div>
                <div class="transaction-date">17 mars 2025, 20:14</div>
            </div>
            <div class="transaction-amount positive">
                +4,00 USDT
            </div>
