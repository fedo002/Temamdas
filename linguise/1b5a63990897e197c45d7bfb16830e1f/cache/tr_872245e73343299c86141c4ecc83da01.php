<?php die(); ?><!DOCTYPE html><html lang="tr" dir="ltr"><head>
    ...
    <title>Madencilik Paketleri | Digiminex Mobile</title>
...
<div class="packages-page">
    <div class="page-header">
        <h1>
            Madencilik paketleri        </h1>
        
        <!-- Package type tabs -->
        <div class="package-tabs">
                            <a href="/tr/packages.php?type=vip" class="tab ">VIP</a>
                 <a href="/tr/packages.php?type=mining" class="tab active">Madencili&#x11F;i</a>
                    </div>
    </div>
