...
<div class="balance-cards">
    ...
    <div class="balance-card main-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">38.369.07 USDT</div>
        </div>
    ...
    <div class="balance-card mining-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">20.200000 USDT</div>
        </div>
        <div class="balance-icon">
...
<div class="recent-transactions">
    ...
    <div class="transactions-list">
            ...
            <div class="transaction-details">
                ...
                <div class="transaction-date">18 Mar 2025, 05:35</div>
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Oyun &#xF6;d&#xFC;l&#xFC;</span>                </div>
                <div class="transaction-date">18 Mar 2025, 05:33</div>
            </div>
            <div class="transaction-amount positive">
                +4.20 USDT
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Oyun &#xF6;d&#xFC;l&#xFC;</span>                </div>
                <div class="transaction-date">18 Mar 2025, 05:23</div>
            </div>
            <div class="transaction-amount positive">
                +3.00 USDT
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Oyun &#xF6;d&#xFC;l&#xFC;</span>                </div>
                <div class="transaction-date">18 Mar 2025, 03:39</div>
            </div>
            <div class="transaction-amount positive">
                +4.00 USDT
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Oyun &#xF6;d&#xFC;l&#xFC;</span>                </div>
                <div class="transaction-date">18 Mar 2025, 03:36</div>
            </div>
            <div class="transaction-amount positive">
                +3.00 USDT
            </div>
