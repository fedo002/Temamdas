<?php die(); ?><!DOCTYPE html><html lang="fr" dir="ltr"><head>
    ...
    <title>Jeu de r&#xE9;compense quotidien | Digiminex Mobile</title>
...
<div class="daily-game-page">
    ...
    <div class="game-header">
        <h1>Jeu de r&#xE9;compense quotidien</h1>
        <p>Essayez votre chance et gagnez des r&#xE9;compenses USDT!</p>
        
        <div class="game-stats">
            <div class="stat-badge">
                <i class="fas fa-gamepad"></i>
                <span>Essais restants: <strong>62</strong></span>
            </div>
            <div class="stat-badge">
                <i class="fas fa-percentage"></i>
                <span>Gagner Chance: <strong>80.0%</strong></span>
            </div>
        </div>
        
        <div class="vip-badge">
            <i class="fas fa-crown"></i> Niveau VIP: argent        </div>
    </div>
    ...
    <div class="game-area no-translate" data-no-translate="true">
        ...
        <div class="game-stage" id="direct-reward">
            <h2>Votre r&#xE9;compense quotidienne</h2>
            <p>4.2 USDT Pr&#xEA;t! Prenez-le maintenant ou tentez votre chance pour plus?</p>
            
            <div class="game-explanation">
                <div class="explanation-option">
                    <i class="fas fa-check-circle"></i>
                    <h3>Prendre la r&#xE9;compense</h3>
                    <p>Obtenez une garantie de 4,2 USDT maintenant</p>
                </div>
                <div class="explanation-option">
                    <i class="fas fa-dice"></i>
                    <h3>Tentez votre chance</h3>
                    <p>Risquez votre r&#xE9;compense garantie pour une chance de gagner jusqu&apos;&#xE0; 6 USDT!</p>
                </div>
            </div>
            
            <div class="decision-buttons"><i class="fas fa-check-circle"></i>
                    
                <button class="btn btn-success" onclick="takePrize()">Prenez 4,2 USDT</button>
                 <i class="fas fa-dice"></i>
                    <button class="btn btn-warning" onclick="doubleOrNothing()">tentez votre chance</button>
            </div>
        </div>
        <!-- Card Selection (hidden initially) -->
        <div class="game-stage" id="card-selection" style="display: none;">
            <h2>Choisissez votre carte</h2>
            <p>S&#xE9;lectionnez une carte pour voir votre r&#xE9;compense!</p>
            
            <div class="possible-rewards">
                <span>R&#xE9;compenses possibles:</span>
            ...
            <div id="timer-container" class="timer-container">
                ...
                <div class="timer-text">Il est temps de s&#xE9;lectionner une carte: <span id="timer-seconds">30</span> secondes</div>
            </div>
    ...
    <div class="modal no-translate" id="resultModal" data-no-translate="true">
        <div class="modal-content">
            <div class="modal-header">
                <h3 id="resultModalTitle">F&#xE9;licitations!</h3>
            ...
            <div class="modal-footer" id="resultModalFooter">
                <button onclick="closeModal()" class="btn btn-primary">D&apos;ACCORD</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal no-translate" id="countdownModal" data-no-translate="true">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Vous n&apos;avez pas s&#xE9;lectionn&#xE9; de carte dans le d&#xE9;lai.</p>
                <p>La r&#xE9;compense la plus basse a &#xE9;t&#xE9; ajout&#xE9;e &#xE0; votre compte.</p>
            </div>
            <div class="modal-footer">
                <button onclick="window.location.reload()" class="btn btn-primary">D&apos;ACCORD</button>
            </div>
        </div>
    </div>
    ...
    <div id="loadingOverlay" class="loading-overlay no-translate" data-no-translate="true">
        ...
        <p>Traitement de votre r&#xE9;compense ...</p>
    </div>
    ...
    <div class="custom-message-box no-translate" id="custom-message-box" data-no-translate="true" style="display: none;">
        <div class="message-box-content">
            <div class="message-box-header">
                <h3 id="message-box-title">Demande de confirmation</h3>
            </div>
            <div class="message-box-body">
                <p id="message-box-message">Si vous choisissez de tenter votre chance, vous recevrez la r&#xE9;compense la plus basse si vous quittez le jeu et votre tentative sera compt&#xE9;e. Voulez-vous continuer?</p>
            </div>
            <div class="message-box-footer">
                <button id="message-box-confirm" class="btn btn-primary">OK</button>
                 <button id="message-box-cancel" class="btn btn-outline">Annuler</button>
            </div>
        </div>
    </div>
    ...
    <nav class="mobile-bottom-nav">
        ...
        <a href="/fr/packages.php" class="nav-item ">
            ...
            <span data-i18n="buttons.packages">Packages</span>
                    ...
                    <a href="/fr/daily-game.php" class="nav-item nav-item-main active">
                <div class="main-btn">
