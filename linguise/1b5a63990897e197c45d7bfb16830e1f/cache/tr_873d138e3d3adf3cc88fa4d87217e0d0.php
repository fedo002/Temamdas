...
<div class="balance-cards">
    ...
    <div class="balance-card main-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">37.636.07 USDT</div>
        </div>
    ...
    <div class="balance-card mining-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">316.50 USDT</div>
        </div>
        <div class="balance-icon">
...
<div class="recent-transactions">
    ...
    <div class="transactions-list">
            ...
            <div class="transaction-details">
                ...
                <div class="transaction-date">19 Mar 2025, 01:34</div>
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Oyun &#xF6;d&#xFC;l&#xFC;</span>                </div>
                <div class="transaction-date">19 Mar 2025, 01:32</div>
            </div>
            <div class="transaction-amount positive">
                +35.00 USDT
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Oyun &#xF6;d&#xFC;l&#xFC;</span>                </div>
                <div class="transaction-date">19 Mar 2025, 00:19</div>
            </div>
            <div class="transaction-amount positive">
                +55.00 USDT
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Oyun &#xF6;d&#xFC;l&#xFC;</span>                </div>
                <div class="transaction-date">19 Mar 2025, 00:17</div>
            </div>
            <div class="transaction-amount positive">
                +75.00 USDT
            </div>
