<?php die(); ?><!DOCTYPE html><html lang="tr" dir="ltr"><head>
    ...
    <title>Depozito | Digiminex Mobile</title>
...
<div class="deposit-page">
    <h1 class="page-title">Yat&#x131;rmak</h1>
    
    <!-- Main Content -->
    <div class="deposit-container">
                <!-- Deposit Form - Keep this part the same but translate to English -->
        <div class="card deposit-form-card">
            <h2><i class="fas fa-wallet"></i> Para yat&#x131;rma fonlar&#x131;</h2>
            
                        
            <form method="POST" id="depositForm">
                <div class="form-group">
                    <label for="amount">Depozito tutar&#x131; (USD)</label>
                    <div class="input-group">
                        <span class="input-prefix">$</span>
                        <input type="number" id="amount" name="amount" min="10" step="1" placeholder required>
                    </div>
                    <div class="form-hint">Minimum depozito miktar&#x131;: 10.00 USD</div>
                </div>
                ...
                <div class="alert alert-info">
                    ...
                    <div class="alert-content">
                        ...
                        <p>Kripto para birimi ile &#xF6;deme yapabilirsiniz. &#xD6;deme tamamland&#x131;ktan sonra bakiyeniz otomatik olarak g&#xFC;ncellenecektir.</p>
                    </div>
                </div>
                
                <button type="submit" class="btn btn-primary btn-block">
                    <i class="fas fa-wallet"></i> Yat&#x131;rmak
                </button>
            </form>
        </div>
        ...
        <div class="card info-card">
            ...
            <ul class="info-list">
                <li>
                    ...
                    <div>
                        <strong>Minimum depozito:</strong>
                         <span>10.00 USD</span>
                    </div>
                </li>
                <li>
                    ...
                    <div>
                        <strong>&#xD6;deme y&#xF6;ntemi:</strong>
                         <span>kripto para birimi (USDT)</span>
                    </div>
                </li>
                <li>
                    <i class="fas fa-check-circle"></i>
                    <div>
                        <strong>&#x130;&#x15F;leme S&#xFC;resi:</strong>
                         <span>Genellikle 5-30 dakika</span>
                    </div>
                </li>
                <li>
                    <i class="fas fa-check-circle"></i>
                    <div>
                        <strong>&#x130;&#x15F;lem &#xFC;creti:</strong>
                         <span>yok</span>
                    </div>
                </li>
            </ul>
            ...
            <div class="alert alert-warning">
                ...
                <span>&#xD6;demeniz g&#xFC;venli bir &#x15F;ekilde i&#x15F;lenecektir. Herhangi bir sorunla kar&#x15F;&#x131;la&#x15F;&#x131;rsan&#x131;z, l&#xFC;tfen destek ekibimizle ileti&#x15F;ime ge&#xE7;in.</span>
            </div>
        </div>
        
        <!-- Recent Deposits -->
                <div class="card recent-deposits-card">
            <h3><i class="fas fa-history"></i> Son Mevduatlar</h3>
            
            <div class="deposits-list">
                                <div class="deposit-item">
                    <div class="deposit-details">
                        <div class="deposit-amount">50.00 USD</div>
                        <div class="deposit-date">16.03.2025 17:01</div>
                    </div>
                    <div class="deposit-status">
                                                    <span class="status-badge status-pending">Ask&#x131;da olmas&#x131;</span>
                                            </div>
                </div>
                                <div class="deposit-item">
                    <div class="deposit-details">
                        <div class="deposit-amount">50.00 USD</div>
                        <div class="deposit-date">16.03.2025 16:53</div>
                    </div>
                    <div class="deposit-status">
                                                    <span class="status-badge status-pending">Ask&#x131;da olmas&#x131;</span>
                                            </div>
                    ...
                    <div class="deposit-details">
                        <div class="deposit-amount">50.00 USD</div>
                        <div class="deposit-date">15.03.2025 21:51</div>
                    </div>
                    <div class="deposit-status">
                                                    <span class="status-badge status-pending">Ask&#x131;da olmas&#x131;</span>
                                            </div>
                                ...
                                <div class="deposit-item">
                    <div class="deposit-details">
                        <div class="deposit-amount">100.00 USD</div>
                        <div class="deposit-date">15.03.2025 04:28</div>
                    </div>
                    <div class="deposit-status">
                                                    <span class="status-badge status-pending">Ask&#x131;da olmas&#x131;</span>
                                            </div>
            ...
            <a href="/tr/transactions.php?filter=deposit" class="btn btn-outline btn-sm btn-block">
                <i class="fas fa-list"></i> T&#xFC;m Mevduatlar&#x131; G&#xF6;r&#xFC;nt&#xFC;le
            </a>
        </div>
                    </div>
</div>
