...
<div class="user-welcome">
    <div class="welcome-header">
        ...
        <div class="welcome-text">
            <h2 data-i18n="dashboard.welcome">Tekrar ho&#x15F;geldiniz,</h2><h2> Pranga!</h2>
...
<div class="balance-cards">
    ...
    <div class="balance-card main-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">38.272.47 USDT</div>
        </div>
    ...
    <div class="balance-card mining-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">96.800000 USDT</div>
        </div>
        <div class="balance-icon">
    ...
    <div class="balance-card ref-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">13.600000 USDT</div>
        </div>
        <div class="balance-icon">
            <i class="fas fa-wallet"></i>
        </div>
    ...
    <div class="transactions-list">
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.referral">Tavsiye Komisyonu</span>                </div>
                <div class="transaction-date">18 Mar 2025, 21:14</div>
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.referral">Tavsiye Komisyonu</span>                </div>
                <div class="transaction-date">18 Mar 2025, 21:13</div>
            </div>
            <div class="transaction-amount positive">
                +0.80 USDT
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.referral">Tavsiye Komisyonu</span>                </div>
                <div class="transaction-date">18 Mar 2025, 21:00</div>
            </div>
            <div class="transaction-amount positive">
                +1.20 USDT
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.referral">Tavsiye Komisyonu</span>                </div>
                <div class="transaction-date">18 Mar 2025, 20:56</div>
            </div>
            <div class="transaction-amount positive">
                +1.16 USDT
            </div>
            ...
            <div class="transaction-details">
                ...
                <div class="transaction-date">18 Mar 2025, 20:44</div>
            </div>
            <div class="transaction-amount positive">
                +4.20 USDT
            </div>
