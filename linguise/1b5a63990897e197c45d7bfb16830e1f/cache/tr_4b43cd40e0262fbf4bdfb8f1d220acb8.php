...
<div class="balance-cards">
    ...
    <div class="balance-card main-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">37.220.47 USDT</div>
        </div>
    ...
    <div class="balance-card yesday-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">268.720000 USDT</div>
        </div>
        <div class="balance-icon">
            <i class="fas fa-chart-line"></i>
        </div>
...
<div class="recent-transactions">
    ...
    <div class="transactions-list">
            ...
            <div class="transaction-details">
                ...
                <div class="transaction-date">18 Mar 2025, 23:21</div>
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Oyun &#xF6;d&#xFC;l&#xFC;</span>                </div>
                <div class="transaction-date">18 Mar 2025, 23:20</div>
            </div>
            <div class="transaction-amount positive">
                +29.00 USDT
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Oyun &#xF6;d&#xFC;l&#xFC;</span>                </div>
                <div class="transaction-date">18 Mar 2025, 23:03</div>
            </div>
            <div class="transaction-amount positive">
                +29.00 USDT
            </div>
