<?php die(); ?><!DOCTYPE html><html lang="de" dir="ltr"><head>
    ...
    <title>Login | Digiminex Mobile</title>
...
<div class="auth-page login-page">
    <div class="auth-container">
        ...
        <div class="auth-form">
            <h2 class="auth-title" data-i18n="login.title">Willkommen zur&#xFC;ck</h2>
            <p class="auth-subtitle" data-i18n="login.subtitle">Melden Sie sich in Ihrem Konto an</p>
            
            <form method="POST" action class="login-form">
                <div class="form-group">
                    <label for="username" data-i18n="login.username_email">Benutzername / E -Mail</label>
                    <div class="input-wrapper">
                        <i class="fas fa-user"></i>
                        <input type="text" id="username" name="username" class="form-control" placeholder="Geben Sie Ihren Benutzernamen oder Ihre E -Mail ein" value required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="password-label">
                        <label for="password" data-i18n="login.password">Passwort</label>
                         <a href="/de/forgot-password.php" class="forgot-password" data-i18n="login.forgot_password">Passwort vergessen?</a>
                    </div>
                    <div class="input-wrapper">
                        <i class="fas fa-lock"></i>
                        <input type="password" id="password" name="password" class="form-control" placeholder="Geben Sie Ihr Passwort ein" required>
                ...
                <div class="form-group remember-me">
                    <div class="custom-checkbox">
                        ...
                        <label for="remember_me" data-i18n="login.remember_me">Erinnere dich an mich</label>
                    </div>
                </div>
        ...
        <div class="auth-footer">
            <p data-i18n="login.no_account">Sie haben kein Konto?</p>
            <a href="/de/register.php" class="btn btn-outline-primary" data-i18n="login.create_account">Benutzerkonto erstellen</a>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <nav class="mobile-bottom-nav">
        <a href="/de/index.php" class="nav-item ">
         ...
         <a href="/de/login.php" class="nav-item active">
