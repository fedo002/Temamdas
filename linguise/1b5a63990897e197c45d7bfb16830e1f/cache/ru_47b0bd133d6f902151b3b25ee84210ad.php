<?php die(); ?><!DOCTYPE html><html lang="ru" dir="ltr"><head>
    ...
    <title>daily_game.page_title | Digiminex Mobile</title>
...
<div class="daily-game-page">
    ...
    <div class="game-header">
        <h1>daily_game.header_title</h1>
        <p>daily_game.header_subtitle</p>
        
        <div class="game-stats">
            <div class="stat-badge">
                <i class="fas fa-gamepad"></i>
                <span>daily_game.stats.attempts: <strong>97</strong></span>
            </div>
            <div class="stat-badge">
                <i class="fas fa-percentage"></i>
                <span>daily_game.stats.win_chance: <strong>80.0%</strong></span>
            </div>
        </div>
        
        <div class="vip-badge">
            <i class="fas fa-crown"></i> daily_game.stats.vip_level: &#x441;&#x435;&#x440;&#x435;&#x431;&#x440;&#x43E;        </div>
    </div>
    ...
    <div class="game-area no-translate" data-no-translate="true">
        ...
        <div class="game-stage" id="direct-reward">
            <h2>daily_game.stage1.title</h2>
            <p>daily_game.stage1.description</p>
            
            <div class="game-explanation">
                <div class="explanation-option">
                    <i class="fas fa-check-circle"></i>
                    <h3>daily_game.stage1.option1.title</h3>
                    <p>daily_game.stage1.option1.description</p>
                </div>
                <div class="explanation-option">
                    <i class="fas fa-dice"></i>
                    <h3>daily_game.stage1.option2.title</h3>
                    <p>daily_game.stage1.option2.description</p>
                </div>
            </div>
            
            <div class="decision-buttons"><i class="fas fa-check-circle"></i>
                    
                <button class="btn btn-success" onclick="takePrize()">daily_game.stage1.btn_take</button>
                 <i class="fas fa-dice"></i>
                    <button class="btn btn-warning" onclick="doubleOrNothing()">daily_game.stage1.btn_try_luck</button>
            </div>
        </div>
        <!-- Card Selection (hidden initially) -->
        <div class="game-stage" id="card-selection" style="display: none;">
            <h2>daily_game.stage2.title</h2>
            <p>daily_game.stage2.description</p>
            
            <div class="possible-rewards">
                <span>daily_game.stage2.possible_rewards</span>
            ...
            <div id="timer-container" class="timer-container">
                ...
                <div class="timer-text">daily_game.stage2.timer_text</div>
            </div>
                    ...
                    <div class="card-inner">
                        <div class="card-front card-color-1">
                            <div class="card-content">
                                ...
                                <span>daily_game.stage2.card_prefix 1</span>
                            </div>
                        </div>
                        <div class="card-back">
                ...
                <div class="game-card" id="card2" onclick="selectCard(&apos;card2&apos;)" style="display: none;">
                    <div class="card-inner">
                        <div class="card-front card-color-2">
                            <div class="card-content">
                                <i class="fas fa-question"></i>
                                <span>Daily_game.stage2.card_prefix 2</span>
                            </div>
                        </div>
                        <div class="card-back">
                ...
                <div class="game-card" id="card3" onclick="selectCard(&apos;card3&apos;)" style="display: none;">
                    <div class="card-inner">
                        <div class="card-front card-color-3">
                            <div class="card-content">
                                <i class="fas fa-question"></i>
                                <span>daily_game.stage2.card_prefix 3</span>
                            </div>
                        </div>
                        <div class="card-back">
