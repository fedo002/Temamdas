<?php die(); ?><!DOCTYPE html><html lang="az" dir="rtl"><head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <meta name="theme-color" content="#7367f0">
    <title>Digiminex - tablosu | Digiminex mobil</title>
...
<body>
    ...
    <header class="mobile-header">
        <div class="header-container">
            <a class="header-logo" href="/az/index.php">
...
<div class="user-welcome">
    <div class="welcome-header">
        ...
        <div class="welcome-text">
            <h2 data-i18n="dashboard.welcome">Geri qay&#x131;t</h2><h2> !</h2>
            <p data-i18n="dashboard.account_overview">Budur Hesab&#x131;n&#x131;za Bax&#x131;&#x15F;</p>
        </div>
    </div>
</div>
...
<div class="balance-cards">
    ...
    <div class="balance-card main-balance">
        <div class="balance-info">
            <div class="balance-label" data-i18n="dashboard.main_balance">&#x18F;sas balans</div>
    ...
    <div class="balance-card mining-balance">
        <div class="balance-info">
            <div class="balance-label" data-i18n="dashboard.daily_earnings">G&#xFC;nd&#x259;lik qazanc</div>
    ...
    <div class="balance-card yesday-balance">
        <div class="balance-info">
            <div class="balance-label" data-i18n="dashboard.daily_earnings">D&#xFC;n&#x259;n qazanc</div>
    ...
    <div class="balance-card ref-balance">
        <div class="balance-info">
            <div class="balance-label" data-i18n="dashboard.main_balance">G&#xFC;nd&#x259;lik q&#xFC;sursuz qazanc</div>
...
<div class="quick-actions">
    <h3 data-i18n="dashboard.quick_actions">S&#xFC;r&#x259;tli h&#x259;r&#x259;k&#x259;tl&#x259;r</h3>
    
    <div class="action-buttons">
        <a href="/az/deposit.php" class="action-button">
            <div class="action-icon">
                <i class="fas fa-plus"></i>
            </div>
            <span data-i18n="dashboard.deposit">Depozit</span>
        </a>
        
        <a href="/az/withdraw.php" class="action-button">
            <div class="action-icon">
                <i class="fas fa-minus"></i>
            </div>
            <span data-i18n="dashboard.withdraw">Geri &#xE7;&#x259;kilm&#x259;k</span>
        </a>
        
        <a href="/az/daily-game.php" class="action-button">
            <div class="action-icon">
                <i class="fas fa-gamepad"></i>
            </div>
            <span data-i18n="dashboard.play_game">Oyun oynamaq</span>
        </a>
        
        <a href="/az/referrals.php" class="action-button">
            <div class="action-icon">
                <i class="fas fa-users"></i>
            </div>
            <span data-i18n="dashboard.referrals">Refertral</span>
        </a>

        <a href="/az/mining.php" class="action-button">
            <div class="action-icon">
            <i class="miningicon"></i>
            </div>
            <span data-i18n="dashboard.referrals">Da&#x11F;-m&#x259;d&#x259;n</span>
        </a>
    </div>
</div>
...
<div class="recent-transactions">
    <div class="section-header">
        <h3 data-i18n="dashboard.recent_transactions">Son &#x259;m&#x259;liyyatlar</h3>
        <a href="/az/transactions.php" class="view-all" data-i18n="dashboard.view_all">Ham&#x131;s&#x131;na bax&#x131;n</a>
    </div>
    ...
    <div class="transactions-list">
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Oyun m&#xFC;kafat&#x131;</span>                </div>
                <div class="transaction-date">17 Mart 2025, 20:05</div>
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Oyun m&#xFC;kafat&#x131;</span>                </div>
                <div class="transaction-date">17 Mart 2025, 19:30</div>
            </div>
            <div class="transaction-amount positive">
                +6.00 USDT
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Oyun m&#xFC;kafat&#x131;</span>                </div>
                <div class="transaction-date">17 Mart 2025, 19:22</div>
            </div>
            <div class="transaction-amount positive">
                +4.20 USDT
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Oyun m&#xFC;kafat&#x131;</span>                </div>
                <div class="transaction-date">17 Mart 2025, 19:16</div>
            </div>
            <div class="transaction-amount positive">
                +4.20 USDT
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <nav class="mobile-bottom-nav">
        <a href="/az/index.php" class="nav-item active">
            <i class="fas fa-home"></i>
            <span data-i18n="buttons.home">Evd&#x259;</span>
        </a>
        
        <a href="/az/packages.php" class="nav-item ">
            <i class="fas fa-cubes"></i>
            <span data-i18n="buttons.packages">Paketl&#x259;r</span>
        </a>
        
                    <a href="/az/daily-game.php" class="nav-item nav-item-main ">
                <div class="main-btn">
            ...
            <a href="/az/notifications.php" class="nav-item ">
                <i class="fas fa-bell"></i>
                                <span data-i18n="buttons.notifications">Bildiri&#x15F;l&#x259;r</span>
            </a>
            
            <a href="/az/profile.php" class="nav-item ">
                <i class="fas fa-user"></i>
                <span data-i18n="buttons.myAccount">Hesab</span>
            </a>
            </nav>
