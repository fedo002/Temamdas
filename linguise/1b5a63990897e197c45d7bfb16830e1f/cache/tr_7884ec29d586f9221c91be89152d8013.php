...
<div class="auth-page login-page">
    <div class="auth-container">
        <div class="auth-logo">
            ...
            <i class="fas fa-exclamation-circle me-2"></i> Gitersiz KullaniC&#x131; Adi/E-Posta Veya &#x15E;ifre.        </div>
            ...
            <form method="POST" action class="login-form">
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="username" name="username" class="form-control" placeholder="Kullan&#x131;c&#x131; ad&#x131;n&#x131;z&#x131; veya e -postan&#x131;z&#x131; girin" value="ilkinn_77" required>
                    </div>
                </div>
