...
<div class="balance-cards">
    ...
    <div class="balance-card main-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">38.211.27 USDT</div>
        </div>
    ...
    <div class="balance-card mining-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">26.492000 USDT</div>
        </div>
        <div class="balance-icon">
    ...
    <div class="balance-card ref-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">4.492000 USDT</div>
        </div>
        <div class="balance-icon">
            <i class="fas fa-wallet"></i>
        </div>
...
<div class="recent-transactions">
    ...
    <div class="transactions-list">
            ...
            <div class="transaction-details">
                ...
                <div class="transaction-date">17 Mar 2025, 14:26</div>
            </div>
            ...
            <div class="transaction-details">
                ...
                <div class="transaction-date">17 Mar 2025, 14:24</div>
            </div>
            <div class="transaction-amount positive">
                +0.53 USDT
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.referral">Tavsiye Komisyonu</span>                </div>
                <div class="transaction-date">17 Mar 2025, 13:51</div>
            </div>
            <div class="transaction-amount positive">
                +0.80 USDT
            </div>
