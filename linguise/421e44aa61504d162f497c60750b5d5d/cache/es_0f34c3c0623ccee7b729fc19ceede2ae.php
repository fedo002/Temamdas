...
<div class="user-welcome">
    <div class="welcome-header">
        ...
        <div class="welcome-text">
            <h2 data-i18n="dashboard.welcome">Bienvenido de nuevo,</h2><h2> &#xA1;PRANGA!</h2>
...
<div class="balance-cards">
    ...
    <div class="balance-card main-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">38,315.47 USDT</div>
        </div>
    ...
    <div class="balance-card mining-balance">
        <div class="balance-info">
            ...
            <div class="balance-value">135.332000 USDT</div>
        </div>
        <div class="balance-icon">
...
<div class="recent-transactions">
    ...
    <div class="transactions-list">
            ...
            <div class="transaction-details">
                ...
                <div class="transaction-date">17 de marzo de 2025, 19:30</div>
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Recompensa del juego</span>                </div>
                <div class="transaction-date">17 de marzo de 2025, 19:22</div>
            </div>
            <div class="transaction-amount positive">
                +4.20 USDT
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Recompensa del juego</span>                </div>
                <div class="transaction-date">17 de marzo de 2025, 19:16</div>
            </div>
            <div class="transaction-amount positive">
                +4.20 USDT
            </div>
            ...
            <div class="transaction-details">
                <div class="transaction-title">
                    <span data-i18n="dashboard.game">Recompensa del juego</span>                </div>
                <div class="transaction-date">17 de marzo de 2025, 19:02</div>
            </div>
            <div class="transaction-amount positive">
                +4.20 USDT
            </div>
