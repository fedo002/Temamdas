    ...
    <div class="game-header">
        ...
        <div class="game-stats">
            <div class="stat-badge">
                ...
                <span>Kalan denemeler: <strong>951</strong></span>
            </div>
            <div class="stat-badge">
...
console.log("Onay modalı için kullanılabilir çeviriler:", 
    {
        title: getServerTranslation('modals.confirmation.title'),
        message: getServerTranslation('try_luck_warning'),
        fullPathMessage: getServerTranslation('modals.confirmation.try_luck_warning')
    }
);

// Go to cards selection
function doubleOrNothing() {
    console.log("Server translations:", window.serverTranslations);
    console.log("Confirmation title translation:", getServerTranslation('modals.confirmation.title'));
    console.log("Try luck warning translation:", getServerTranslation('try_luck_warning'));
    if (gameState.inProgress) return;
    ...
    console.log("Çeviri değerleri:", {
    titleFromServer: getServerTranslation('modals.confirmation.title'),
    titleFromLocal: translate('modals.confirmation.title'),
    messageFromServer: getServerTranslation('try_luck_warning'),
    messageFromLocal: translate('modals.confirmation.try_luck_warning')
});
showMessageBox(
    getServerTranslation('confirmation_title') || translate('modals.confirmation.title'), 
    getServerTranslation('try_luck_warning') || translate('modals.confirmation.try_luck_warning'),
