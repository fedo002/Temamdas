...
<div class="daily-game-page">
    ...
    <div class="game-header">
        ...
        <div class="game-stats">
            <div class="stat-badge">
                ...
                <span>&#x41E;&#x441;&#x442;&#x430;&#x43B;&#x44C;&#x43D;&#x44B;&#x435; &#x43F;&#x43E;&#x43F;&#x44B;&#x442;&#x43A;&#x438;: <strong>85</strong></span>
            </div>
            <div class="stat-badge">
        ...
        <div class="vip-badge">
            <i class="fas fa-crown"></i> VIP -&#x443;&#x440;&#x43E;&#x432;&#x435;&#x43D;&#x44C;: &#x441;&#x435;&#x440;&#x435;&#x431;&#x440;&#x43E;        </div>
    </div>
    ...
    <div class="game-area no-translate" data-no-translate="true">
        ...
        <div class="game-stage" id="direct-reward">
            ...
            <p>4.2 USDT &#x433;&#x43E;&#x442;&#x43E;&#x432;&#x43E;! &#x412;&#x43E;&#x437;&#x44C;&#x43C;&#x438;&#x442;&#x435; &#x44D;&#x442;&#x43E; &#x441;&#x435;&#x439;&#x447;&#x430;&#x441; &#x438;&#x43B;&#x438; &#x43F;&#x43E;&#x43F;&#x440;&#x43E;&#x431;&#x443;&#x435;&#x442;&#x435; &#x443;&#x434;&#x430;&#x447;&#x443;, &#x447;&#x442;&#x43E;&#x431;&#x44B; &#x443;&#x437;&#x43D;&#x430;&#x442;&#x44C; &#x431;&#x43E;&#x43B;&#x44C;&#x448;&#x435;?</p>
            
            <div class="game-explanation">
                <div class="explanation-option">
                    <i class="fas fa-check-circle"></i>
                    <h3>&#x41F;&#x440;&#x438;&#x43D;&#x44F;&#x442;&#x44C; &#x43D;&#x430;&#x433;&#x440;&#x430;&#x434;&#x443;</h3>
                    <p>&#x41F;&#x43E;&#x43B;&#x443;&#x447;&#x438;&#x442;&#x435; &#x433;&#x430;&#x440;&#x430;&#x43D;&#x442;&#x438;&#x440;&#x43E;&#x432;&#x430;&#x43D;&#x43D;&#x43E;&#x435; 4.2 USDT &#x441;&#x435;&#x439;&#x447;&#x430;&#x441;</p>
                </div>
                <div class="explanation-option">
                    <i class="fas fa-dice"></i>
                    <h3>&#x41F;&#x43E;&#x43F;&#x440;&#x43E;&#x431;&#x443;&#x439;&#x442;&#x435; &#x441;&#x432;&#x43E;&#x44E; &#x443;&#x434;&#x430;&#x447;&#x443;</h3>
                    <p>&#x420;&#x438;&#x441;&#x43A;&#x43D;&#x443;&#x442;&#x44C; &#x441;&#x432;&#x43E;&#x44E; &#x433;&#x430;&#x440;&#x430;&#x43D;&#x442;&#x438;&#x440;&#x43E;&#x432;&#x430;&#x43D;&#x43D;&#x443;&#x44E; &#x43D;&#x430;&#x433;&#x440;&#x430;&#x434;&#x443; &#x437;&#x430; &#x448;&#x430;&#x43D;&#x441; &#x432;&#x44B;&#x438;&#x433;&#x440;&#x430;&#x442;&#x44C; &#x434;&#x43E; 6 USDT!</p>
                </div>
            </div>
            
            <div class="decision-buttons"><i class="fas fa-check-circle"></i>
                    
                <button class="btn btn-success" onclick="takePrize()">&#x412;&#x43E;&#x437;&#x44C;&#x43C;&#x438;&#x442;&#x435; 4.2 USDT,</button>
                 <i class="fas fa-dice"></i>
...
// Orijinal AJAX çağrılarını değiştirin
// Örneğin takePrize fonksiyonunda:
function takePrize() {
    if (gameState.inProgress) return;
    ...
    .then(data => {
        ...
        if (data.status === 'success') {
            ...
            // Show success modal with translated strings
            showResultModal(
                getTranslation('congratulations', 'Congratulations!'), 
                `<i class="fas fa-trophy" style="font-size: 3rem; color: gold; margin-bottom: 15px;"></i>
                <h3>${gameState.reward} USDT</h3>
                <p>${getTranslation('reward_added', 'Your reward has been added to your account.')}</p>`
            );
            ...
            // Show error modal
            showResultModal(
                getTranslation('error_title', 'Error'), 
                `<i class="fas fa-exclamation-triangle" style="font-size: 3rem; color: #ea5455; margin-bottom: 15px;"></i>
                <h3>${getTranslation('error_title', 'Error')}</h3>
                <p>${data.message || getTranslation('check_connection', 'Please try again later.')}</p>`
            );
        }
    })
    .catch(error => {
        ...
        showResultModal(
            getTranslation('error_title', 'Error'), 
            `<i class="fas fa-exclamation-triangle" style="font-size: 3rem; color: #ea5455; margin-bottom: 15px;"></i>
            <h3>${getTranslation('connection_error', 'Connection Error')}</h3>
            <p>${getTranslation('check_connection', 'Please check your internet connection and try again.')}</p>`
        );
...
// Sayfa yüklendiğinde modalleri güncelle
document.addEventListener('DOMContentLoaded', function() {
    // Bir önceki script'teki orijinal DOMContentLoaded işlemlerini yap
    
    // Modalleri güncelle
    updateAllModalsWithTranslations();
    
    // Mevcut dili log'la
    console.log("Current detected language:", gameState.currentLanguage);
});

// showResultModal fonksiyonunu güncelle
function showResultModal(title, content) {
    const modal = document.getElementById('resultModal');
    const backdrop = document.getElementById('backdrop');
    const titleElement = document.getElementById('resultModalTitle');
