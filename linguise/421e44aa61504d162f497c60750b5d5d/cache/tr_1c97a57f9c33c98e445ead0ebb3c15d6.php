...
function doubleOrNothing() {
    ...
    // İşte istediğiniz const tanımlamaları
    const title = getServerTranslation('confirmation_title') || translate('modals.confirmation.title');
    const message = getServerTranslation('confirmation_message') || translate('modals.confirmation.try_luck_warning');
